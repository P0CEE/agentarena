...
def make_genesis(allocations: dict[str, int]) -> tuple[State, dict]:
    """Construit le state initial et le bloc 0 depuis les allocations de solde."""
    state = State.from_allocations(allocations)
